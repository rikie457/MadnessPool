...
public class Shadows extends Entity {
    ...
    /**
     * draw the balls that are on the gui screen their shadows
    ...
    /**
     * draw the balls that are on the pool table their shadows
     * @param gameView = The GameView
     */
    ...
    // returns whether or not this class has balls (it does (usually))
    public boolean hasBalls() {
        return this.balls != null;
    }

    // returns whether or not this class has gui balls
    public boolean hasGUIBalls() {
        return this.player1Balls != null && this.player2Balls != null;
    }

    // replaces this class's balls (because they went missing)
    public void setBalls(ArrayList<Ball> balls) {
        this.balls = balls;
    }

    // replaces this class's gui balls
